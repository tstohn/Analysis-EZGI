...
ESGI_RAW <- read_tsv("/DATA/t.stohn/analyses_ezgi/SIGNALseq_Analysis/output/ezgi_june25/RNA.tsv")
...
convert_df <- read_tsv("/DATA/t.stohn/analyses_ezgi/SIGNALseq_Analysis/background_data/formatForEzgi_files/split_seqv2_rt_bc_sharing.tsv")
ESGI_RAW <- ESGI_RAW %>%
