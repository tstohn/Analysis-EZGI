...
LOGFILE="SIGNALseq_Analysis/output/ESGI_RNA/ESGI_RNA_LOG.txt"
rm $LOGFILE
...
#              -o /DATA/t.stohn/analyses_ezgi/SIGNALseq_Analysis/output/ESGI_RNA \
...
/usr/bin/time -v STAR --runThreadN 70 \
     ...
     --readFilesIn ./SIGNALseq_Analysis/output/ESGI_RNA/RNA.fastq \
     --outFileNamePrefix ./SIGNALseq_Analysis/output/ESGI_RNA/RNA_ \
...
/usr/bin/time -v /DATA/t.stohn/SCDemultiplexing/bin/annotate -i ./SIGNALseq_Analysis/output/ESGI_RNA/RNA.tsv -b ./SIGNALseq_Analysis/output/ESGI_RNA/RNA_Aligned.out.bam -f GX 2>> $LOGFILE
/usr/bin/time -v /DATA/t.stohn/SCDemultiplexing/bin/count -i ./SIGNALseq_Analysis/output/ESGI_RNA/RNA_annotated.tsv \
               -o ./SIGNALseq_Analysis/output/ESGI_RNA/RNA_Counts_umi0.tsv -t 70 \
